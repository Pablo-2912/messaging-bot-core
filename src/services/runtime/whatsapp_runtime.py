...
from src.handlers.chat_processing_handler import proccess_unread_chats
...
class WhatsAppRuntime:
    ...
    def _proccess_unread_chats(self, unread_chats : list[str] ) -> list[str]:
        ...
        contacts : Contact = proccess_unread_chats(chat_identifiers=unread_chats)
        return contacts
    ...
    def _send_responses_to_contacts(self, contacts : list[Contact]) -> None:
        ...
        #TODO: Adicionar metodo que decide qual a mensagem para o contato
        
        
        #TODO: Adicionar for clicando e respondendo os chats 
        pass
